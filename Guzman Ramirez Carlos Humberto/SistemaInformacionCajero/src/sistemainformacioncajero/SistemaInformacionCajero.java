package sistemainformacioncajero;
...
public class SistemaInformacionCajero {
    ...
    public static void main(String[] args) {
        ...
        int opc;
        boolean banderaUsuario = false, banderaBanco = false; String apagar;
        do {
            ...
            System.out.print("Apagar el cajero (si/no): "); apagar =  scanner.nextLine().toLowerCase();
        } while (!apagar.equals("si"));
    }
}
